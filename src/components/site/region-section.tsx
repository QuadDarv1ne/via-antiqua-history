            ...
            >
              ...
              <div className="mt-10 sm:mt-12">
                <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6">
                  <span
                    className="inline-block h-0.75 w-6 sm:w-8 rounded-full"
                    style={{ backgroundColor: region.color }}
                  />
                ...
                <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                  {activeCity.landmarks.map((lm, i) => (
                    <button
                      ...
                      className="group text-left p-4 sm:p-5 rounded-lg border border-border/70 bg-card hover:border-primary/40 hover:shadow-lg transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 animate-fade-slide-up"
